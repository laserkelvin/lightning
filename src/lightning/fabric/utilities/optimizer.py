...
if _TORCH_GREATER_EQUAL_2_0:
    try:
        ...
        SUPPORTS_OPTIMIZER_IN_FSDP_BACKWARD = True

    # Note: Not `ImportError` because sometimes PyTorch has internal failures
    # (such as AttributeError) if it was built without distributed support.
